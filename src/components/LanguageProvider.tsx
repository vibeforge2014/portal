...
const copy = {
  zh: {
    ...
    heroDescription: "我们为 macOS 打造专注、可靠的原生应用。复杂留给技术，简单留给你。",
    browseApps: "浏览全部应用",
    about: "了解 VibeForge",
    overviewLabel: "产品概览",
    onSale: "款在售产品",
    ...
    productMatrix: "产品矩阵",
    productTitle: "专注做好两款\nmacOS 工具。",
    productIntro: "ChargePilot 现已开放购买。\nMinuteFlow 正在准备中，暂不开放购买。",
  ...
  en: {
    ...
    heroDescription: "We build focused, dependable native apps for macOS—keeping the complexity in the technology and the experience simple for you.",
    ...
    productTitle: "Two focused tools\nfor macOS.",
    productIntro: "ChargePilot is available now.\nMinuteFlow is in preparation and not yet for sale.",
